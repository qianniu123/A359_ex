...
#else
#define VECT_TAB_OFFSET (CODE_START_ADDR-0x08000000)
#endif
/**
  * @}
  */
...
void HSI_sysclock_config( uint32_t  RCC_PLLMul_x )
{
    ...
    if ( RCC_CR_HSIRDY == HSIStatus )
    {
		...
		RCC_PLLConfig(RCC_PLLSource_HSI_Div2, RCC_PLLMul_x); //���������໷ PLLCLK = HSI * ��Ƶ����
		//�����������ߵı�Ƶ����
		// HCLK = SYSCLK AHB 36M
		...
		RCC_GetClocksFreq(&RCC_Clock);//�鿴Ƶ��ֵ
...
static void SetSysClock(void)
{
  ...
  SetSysClockTo72();
#elif defined SYSCLK_FREQ_64MHz
	HSI_sysclock_config(RCC_PLLMul_16);
#endif
...
static void SetSysClockTo64_HSI(void)
{
